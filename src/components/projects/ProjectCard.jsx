...
const ProjectCard = ({ project, isAuthenticated }) => {
  ...
  const getStatusText = (details) => {
    ...
    if (details.isValidated && details.isVerified) {
      return 'VERRA/GOLD STANDARD REGISTERED';
    }
  ...
  const getStatusBadgeColor = (status) => {
    switch (status) {
      case 'Approved':
      case 'VERRA/GOLD STANDARD REGISTERED':
        ...
        <div className="flex-shrink-0">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${details.isPresale
          ...
          <div className="flex space-x-3">
            ...
            {isAuthenticated ? (
              <Link to={`/ProjectDetails/${details.projectContract}`} className="flex-1">
                <button className={`w-full py-3 px-4 rounded-lg font-semibold transition-all duration-200 transform hover:scale-[1.02] flex items-center justify-center space-x-2 text-white ${details.isPresale
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="bg-gray-50 border-t border-gray-200 px-3 py-2 flex justify-end">
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-xs font-medium transition-colors ${!comment || Date.now() / 1000 > Number(details.commentPeriodEnd)
